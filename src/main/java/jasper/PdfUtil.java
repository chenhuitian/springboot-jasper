...
public class PdfUtil {
	public static void sign(InputStream src  //需要签章的pdf文件路径
        ...
        appearance.setVisibleSignature(new Rectangle(100, 500, 200, 600), pageCount, "sig1");
//        appearance.setVisibleSignature(new Rectangle(100, 100, 200, 200), pageCount, "sig2");
